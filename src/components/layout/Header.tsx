...
const NAV: NavItem[] = [
...

  {
    ...
    dropCols: 3,
    dropdown: [
      { to: "/areas/auburn", label: "Auburn" },
      { to: "/areas/bellevue", label: "Bellevue" },
      { to: "/areas/bonney-lake", label: "Bonney Lake" },
      { to: "/areas/des-moines", label: "Des Moines" },
      { to: "/areas/federal-way", label: "Federal Way" },
      { to: "/areas/fife", label: "Fife" },
      { to: "/areas/kent", label: "Kent" },
      { to: "/areas/lakewood", label: "Lakewood" },
      { to: "/areas/mercer-island", label: "Mercer Island" },
      { to: "/areas/puyallup", label: "Puyallup" },
      { to: "/areas/renton", label: "Renton" },
      { to: "/areas/seattle", label: "Seattle" },
      { to: "/areas/south-hill", label: "South Hill" },
      { to: "/areas/spanaway", label: "Spanaway" },
      { to: "/areas/summit", label: "Summit" },
      { to: "/areas/summit-view", label: "Summit View" },
      { to: "/areas/tacoma", label: "Tacoma" },
      { to: "/areas/tukwila", label: "Tukwila" },
      { to: "/areas/kirkland", label: "Kirkland" },
      { to: "/areas/redmond", label: "Redmond" },
      { to: "/areas/bothell", label: "Bothell" },
    ],
  },
        ...
        <div className="w-full px-4 sm:px-6 lg:px-10">
          <div className="flex items-center gap-6 pt-2 pb-2.5 min-h-[150px]">
            ...
            <div className="hidden lg:flex flex-col items-center leading-tight ml-auto">
              ...
              <span className="text-[#4A7BC4] font-bold text-[21px] mt-0.5 self-end mr-0">
                Available 24/7
              </span>
